...
const pickBy = require('lodash/pickBy'); // Lodash makes JavaScript easier by taking the hassle out of working with arrays, numbers, objects, strings, etc.
...
module.exports = function getFilters(req, res, next) {
    ...
    req.filters = pickBy(filters, (value, key) => availableFilters.indexOf(key) > -1);
    next();
}